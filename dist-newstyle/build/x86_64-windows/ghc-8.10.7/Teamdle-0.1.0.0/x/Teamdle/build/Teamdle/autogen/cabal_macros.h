...
/* package Teamdle-0.1.0.0 */
#ifndef VERSION_Teamdle
#define VERSION_Teamdle "0.1.0.0"
#endif /* VERSION_Teamdle */
#ifndef MIN_VERSION_Teamdle
#define MIN_VERSION_Teamdle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Teamdle */
...
#define CURRENT_COMPONENT_ID "Teamdle-0.1.0.0-inplace-Teamdle"
